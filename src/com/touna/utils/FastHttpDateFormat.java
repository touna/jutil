...
{
    // -------------------------------------------------------------- Variables
    private static final int CACHE_SIZE = Integer.parseInt(System.getProperty("com.qq.nami.http.FastHttpDateFormat.CACHE_SIZE", "1000"));
    ...
    /**
     * Format the max age for Cookie.
     */
    public static final String formatMaxAge(int maxAge)
    {
    	return OLD_COOKIE_FORMAT.get().format(new Date(System.currentTimeMillis() + maxAge * 1000L));
    }
